...
RUN <<EOR
 ...
 # apt-get --allow-unauthenticated -y -q install git locales build-essential cmake wget sudo curl apt-utils net-tools libzmq3-dev ed openssh-server vim gcc-7 g++-7 gfortran-7 nano htop bmon slurm tcptrack iftop nethogs qpdf alien screen tmux sshfs libpoppler-cpp-dev emacs texinfo texlive-fonts-extra texlive-xetex imagemagick libmagick++-dev libfreetype6-dev librsvg2-dev libwmf-dev libgdk-pixbuf2.0-dev libcairo2-dev dos2unix libnlopt0 libnlopt-dev manpages manpages-dev freebsd-manpages man2html cifs-utils libfontconfig1-dev libpng-dev libhdf5-dev libhdf5-serial-dev libpq-dev libssl-dev libxml2-dev libxt-dev libssh2-1-dev libcurl4-openssl-dev libsasl2-dev libgmp3-dev jags libgsl0-dev libx11-dev mesa-common-dev libglu1-mesa-dev libmpfr-dev libfftw3-dev libtiff5-dev vpnc passwd supervisor libffi-dev libudunits2-dev libgeos-dev tk-dev nfs-common s3fs apt-transport-https iputils-ping rsync libopenmpi-dev openmpi-bin openmpi-common libsodium-dev libtesseract-dev libleptonica-dev libboost-all-dev locate libbz2-dev liblzma-dev libopenblas-dev libpcre2-dev libpcre3-dev libreadline-dev libz-dev unzip libavfilter-dev cargo libnetcdf-dev libnetcdff-dev libnetcdff-doc netcdf-bin netcdf-doc tree glpk-utils libhiredis-dev libwebp-dev tesseract-ocr-eng bwidget devscripts gdebi apache2 libapache2-mod-perl2 libjson-perl cpanminus ca-certificates gnupg-agent software-properties-common libharfbuzz-dev libfribidi-dev uuid-dev psmisc libclang-dev libzstd-dev liblz4-dev cuda-command-line-tools-11-0 cuda-compat-11-0 cuda-cudart-11-0 cuda-nvrtc-11-0 libcublas-11-0 libcudnn8 libcufft-11-0 libcurand-11-0 libcusolver-11-0 libcusparse-11-0 aria2 
 apt-get --allow-unauthenticated -y -q install git locales build-essential cmake wget sudo curl apt-utils net-tools libzmq3-dev ed openssh-server vim nano htop bmon slurm tcptrack iftop nethogs qpdf alien screen tmux sshfs libpoppler-cpp-dev emacs texinfo texlive-fonts-extra texlive-xetex imagemagick libmagick++-dev libfreetype6-dev librsvg2-dev libwmf-dev libgdk-pixbuf2.0-dev libcairo2-dev dos2unix libnlopt0 libnlopt-dev manpages manpages-dev freebsd-manpages man2html cifs-utils libfontconfig1-dev libpng-dev libhdf5-dev libhdf5-serial-dev libpq-dev libssl-dev libxml2-dev libxt-dev libssh2-1-dev libcurl4-openssl-dev libsasl2-dev libgmp3-dev jags libgsl0-dev libx11-dev mesa-common-dev libglu1-mesa-dev libmpfr-dev libfftw3-dev libtiff5-dev vpnc passwd supervisor libffi-dev libudunits2-dev libgeos-dev tk-dev nfs-common s3fs apt-transport-https iputils-ping rsync libopenmpi-dev openmpi-bin openmpi-common libsodium-dev libtesseract-dev libleptonica-dev libboost-all-dev locate libbz2-dev liblzma-dev libopenblas-dev libpcre2-dev libpcre3-dev libreadline-dev libz-dev unzip libavfilter-dev cargo libnetcdf-dev libnetcdff-dev libnetcdff-doc netcdf-bin netcdf-doc tree glpk-utils libhiredis-dev libwebp-dev tesseract-ocr-eng bwidget devscripts gdebi apache2 libapache2-mod-perl2 libjson-perl cpanminus ca-certificates gnupg-agent software-properties-common libharfbuzz-dev libfribidi-dev uuid-dev psmisc libclang-dev libzstd-dev liblz4-dev cuda-command-line-tools-11-0 cuda-compat-11-0 cuda-cudart-11-0 cuda-nvrtc-11-0 libcublas-11-0 libcudnn8 libcufft-11-0 libcurand-11-0 libcusolver-11-0 libcusparse-11-0 aria2 
