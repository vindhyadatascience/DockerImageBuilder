...
class PyBuildExt(build_ext):
    ...
    def configure_compiler(self):
        ...
        if not CROSS_COMPILING:
            add_dir_to_list(self.compiler.library_dirs, '/opt/tbio/domino_202305/lib')
            add_dir_to_list(self.compiler.include_dirs, '/opt/tbio/domino_202305/include')
    ...
    def detect_sqlite(self):
        ...
        sqlite_inc_paths = [ '/usr/include',
                             '/usr/include/sqlite',
                             '/usr/include/sqlite3',
                             '/opt/tbio/domino_202305/include',
                             ]
        if CROSS_COMPILING:
            sqlite_inc_paths = []
