...
export PATH=/usr/local/bin:$BUILD_PREFIX/binaries/cmake-3.22.3/bin:$BUILD_PREFIX/binaries/python-3.12.7/bin:$BUILD_PREFIX/binaries/$R_version/bin:$BUILD_PREFIX/bin:$JAVA_HOME/bin:$PATH:/opt/code-server/bin:/usr/lib/rstudio-server/bin/quarto/bin/tools
export PATH=$PATH:$BUILD_PREFIX/Anaconda3/bin # places conda on the path without overriding default Python
export PKG_CONFIG_PATH=$BUILD_PREFIX/lib/pkgconfig
export RETICULATE_PYTHON=$BUILD_PREFIX/binaries/python-3.12.7/bin/python3
